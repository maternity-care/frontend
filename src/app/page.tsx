...
const packages = [
  ...
  },
  {
    ...
    benefits: [
      "Tư vấn ưu tiên",
      "Nhiều quyền lợi dịch vụ",
      "Theo dõi thai kỳ nâng cao",
    ],
  },
];
...
export default function HomePage() {
  ...
  const badge = getOrDefault(
    "home_badge",
    RESPONSE_MESSAGES.HOME.HERO.DEFAULT_BADGE
  );
        ...
        <div className="space-y-20 pb-16">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-8 flex flex-wrap gap-3">
                    ...
                    <Link href="/management/login">
                      ...
                      >
                        {RESPONSE_MESSAGES.HOME.HERO.MANAGEMENT}
                      </Button>
                    </Link>
                  </div>
                ...
                >
                  ...
                  <div className="grid gap-4">
                    <Select
                      size="large"
                      placeholder={
                        RESPONSE_MESSAGES.HOME.QUICK_APPOINTMENT
                          .FACILITY_PLACEHOLDER
                      }
                      options={[
          ...
          <section>
            <div className="mx-auto max-w-3xl text-center">
              <Tag color="pink" className="!mb-3 !rounded-full !px-4 !py-1">
                {RESPONSE_MESSAGES.HOME.PAIN_POINTS.TAG}
              </Tag>

              <Title level={2} className="!mb-3 !text-slate-950">
                {RESPONSE_MESSAGES.HOME.PAIN_POINTS.TITLE}
              </Title>

              <Paragraph className="!text-base !leading-7 !text-slate-600">
                {RESPONSE_MESSAGES.HOME.PAIN_POINTS.DESCRIPTION}
              </Paragraph>
            </div>
            ...
            <Row gutter={[16, 16]} className="mt-8">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Chọn cơ sở, dịch vụ, bác sĩ và khung giờ phù hợp.",
                  icon: Hospital,
                },
                {
          ...
          <section>
            <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
              <div>
                <Tag color="pink" className="!mb-3 !rounded-full !px-4 !py-1">
                  {RESPONSE_MESSAGES.HOME.SERVICES_SECTION.TAG}
                </Tag>

                <Title level={2} className="!mb-2 !text-slate-950">
                  {RESPONSE_MESSAGES.HOME.SERVICES_SECTION.TITLE}
                </Title>

                <Paragraph className="!mb-0 max-w-2xl !text-slate-600">
                  {RESPONSE_MESSAGES.HOME.SERVICES_SECTION.DESCRIPTION}
                </Paragraph>
              </div>

              <Link href="/login">
                <Button className="!rounded-full !border-pink-200 !text-pink-600">
                  {RESPONSE_MESSAGES.HOME.SERVICES_SECTION.VIEW_ALL}
                </Button>
              </Link>
            </div>
          ...
          <section className="rounded-[32px] bg-pink-50/70 px-6 py-10 md:px-10">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <Title level={2} className="!mb-3 !text-slate-950">
                {RESPONSE_MESSAGES.HOME.PACKAGES_SECTION.TITLE}
              </Title>

              <Paragraph className="!text-base !leading-7 !text-slate-600">
                {RESPONSE_MESSAGES.HOME.PACKAGES_SECTION.DESCRIPTION}
              </Paragraph>
            </div>
                ...
                <Col xs={24} md={8} key={item.name}>
                  ...
                  >
                    <div className="mb-4 flex items-center justify-between">
                      ...
                      <Tag
                        color={item.highlight ? "magenta" : "pink"}
          ...
          <section>
            <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
              <div>
                <Tag color="pink" className="!mb-3 !rounded-full !px-4 !py-1">
                  {RESPONSE_MESSAGES.HOME.DOCTORS_SECTION.TAG}
                </Tag>

                <Title level={2} className="!mb-2 !text-slate-950">
                  {RESPONSE_MESSAGES.HOME.DOCTORS_SECTION.TITLE}
                </Title>

                <Paragraph className="!mb-0 max-w-2xl !text-slate-600">
                  {RESPONSE_MESSAGES.HOME.DOCTORS_SECTION.DESCRIPTION}
                </Paragraph>
              </div>
            </div>
          ...
          <section>
            <div className="mx-auto max-w-3xl text-center">
              <Tag color="pink" className="!mb-3 !rounded-full !px-4 !py-1">
                {RESPONSE_MESSAGES.HOME.PROCESS_SECTION.TAG}
              </Tag>

              <Title level={2} className="!mb-3 !text-slate-950">
                {RESPONSE_MESSAGES.HOME.PROCESS_SECTION.TITLE}
              </Title>

              <Paragraph className="!text-base !leading-7 !text-slate-600">
                {RESPONSE_MESSAGES.HOME.PROCESS_SECTION.DESCRIPTION}
              </Paragraph>
            </div>
          ...
          <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            <Card className="!rounded-3xl !border-pink-100 !bg-gradient-to-br !from-white !to-pink-50">
              ...
              <Title level={2} className="!mb-3 !text-slate-950">
                {RESPONSE_MESSAGES.HOME.SUPPORT_SECTION.TITLE}
              </Title>

              <Paragraph className="!text-base !leading-7 !text-slate-600">
                {RESPONSE_MESSAGES.HOME.SUPPORT_SECTION.DESCRIPTION}
              </Paragraph>

              <Paragraph className="!text-sm !leading-6 !text-slate-500">
                {RESPONSE_MESSAGES.HOME.SUPPORT_SECTION.NOTE}
              </Paragraph>

              <Link href="/login">
                <Button
                  type="primary"
                  className="!mt-3 !rounded-xl !bg-pink-500"
                >
            ...
            <Card className="!rounded-3xl !border-pink-100">
              <Title level={3} className="!mb-5 !text-slate-950">
                {RESPONSE_MESSAGES.HOME.SUPPORT_SECTION.FAQ_TITLE}
              </Title>
          ...
          <section className="rounded-[32px] bg-gradient-to-r from-pink-500 to-rose-400 px-6 py-10 text-center text-white md:px-10">
            <Title level={2} className="!mb-3 !text-white">
              {RESPONSE_MESSAGES.HOME.FINAL_CTA.TITLE}
            </Title>

            <Paragraph className="mx-auto max-w-2xl !text-base !leading-7 !text-pink-50">
              {RESPONSE_MESSAGES.HOME.FINAL_CTA.DESCRIPTION}
            </Paragraph>
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              <Link href="/register">
                <Button
                  size="large"
                  className="!h-12 !rounded-full !border-white !bg-white !px-7 !font-semibold !text-pink-600"
                >
                  {RESPONSE_MESSAGES.AUTH.REGISTER_NOW}
                </Button>
              </Link>
              ...
              <Link href="/login">
                <Button
                  size="large"
                  className="!h-12 !rounded-full !border-white/70 !bg-transparent !px-7 !font-semibold !text-white"
                >
                  {RESPONSE_MESSAGES.HOME.FINAL_CTA.BOOK_APPOINTMENT}
                </Button>
              </Link>
            </div>
          </section>
