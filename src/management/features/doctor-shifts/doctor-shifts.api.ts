...
/** Man lich dung endpoint nay de lay tron ngay/tuan/thang bang dung mot request. */
export async function getDoctorShiftsInRange(
  params: GetDoctorShiftRangeParams,
): Promise<DoctorShiftListResult> {
  const data = await unwrapApiData<DoctorShiftListData>(
    apiClient.get(`${ENDPOINT}/range`, {
