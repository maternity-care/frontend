export const RESPONSE_MESSAGES = {
  COMMON: {
    ...
    status: {
      ...
      available: "Đang cung cấp",
      unavailable: "Ngừng cung cấp",
      draft: "Bản nháp",
      required: "Bắt buộc",
      optional: "Tùy chọn",
      not_yet_regulated: "Chưa quy định",
      prioritize: "Ưu tiên",
    },
    log: {
  ...
  SERVICES: {
    ...
    MODAL: {
      facility: "Cơ sở",
      base_price: "Giá gốc",
      facility_price: "Giá tại cơ sở",
      details_of_facility_services: "Chi tiết dịch vụ cơ sở",
      duration: "Thời lượng",
      assign_services: "Gán dịch vụ",
      assign_services_to_facility: "Gán dịch vụ cho cơ sở",
      update_facility_services: "Cập nhật dịch vụ cơ sở",
      select_facility: "Chọn cơ sở",
      please_select_facility: "Vui lòng chọn cơ sở",
      please_select_services: "Vui lòng chọn dịch vụ",
      includedQuantity: "Số lần sử dụng",
      basis_for_application: "Cơ sở áp dụng",
      all_facility: "Tất cả cơ sở",
      service_package_details: "Chi tiết gói dịch vụ",
      package_id: "Mã gói",
      package_name: "Tên gói",
      package_price: "Giá gói",
      package_duration: "Thời lượng gói",
      package_services: "Dịch vụ trong gói",
    },
  },
};