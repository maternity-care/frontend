export const RESPONSE_MESSAGES = {
  ...
  VALIDATION_FAILED: "Dữ liệu chưa hợp lệ. Vui lòng kiểm tra lại các trường bắt buộc.",
  ...
  FACILITY_INFO_CREATE_DESCRIPTION: "Nhập tên, mã cơ sở, liên hệ và trạng thái hoạt động.",
  FACILITY_INFO_UPDATE_DESCRIPTION: "Cập nhật tên, mã cơ sở, liên hệ và trạng thái hoạt động.",
  FACILITY_INFO_DETAIL_DESCRIPTION: "Liên hệ, mã cơ sở và địa chỉ hành chính.",
  ...
  ADD_FACILITY_DESCRIPTION: "Tạo cơ sở mới để quản lý lịch khám, dịch vụ và thông tin liên hệ.",
  UPDATE_FACILITY_DESCRIPTION: "Chỉnh sửa thông tin cơ sở khám, địa chỉ, liên hệ và trạng thái hoạt động.",
  ...
  LOCATION_TIME_CREATE_DESCRIPTION: "Cập nhật địa chỉ, khu vực và tọa độ cơ sở.",
  LOCATION_TIME_UPDATE_DESCRIPTION: "Cập nhật địa chỉ, khu vực, tọa độ và thời gian hoạt động.",

  SYSTEM_TIME: "Thời gian & hệ thống",
  SYSTEM_TIME_DESCRIPTION: "Giờ mở cửa, giờ đóng cửa, tọa độ và lịch sử cập nhật.",
  ...
  CREATE_SUCCESS_CONTENT: "Cơ sở khám mới đã được tạo và hiển thị trong danh sách.",
  ...
  DELETE_SELECTED_SUCCESS_CONTENT: "Các cơ sở đã chọn đã được xóa khỏi danh sách.",
  ...
  CONFIRM_UPDATE_DESCRIPTION: "Vui lòng nhập lý do cập nhật trước khi lưu thay đổi.",
  UPDATE_REASON: "Lý do cập nhật",
  UPDATE_REASON_REQUIRED: "Vui lòng nhập lý do cập nhật.",
  UPDATE_REASON_PLACEHOLDER: "Ví dụ: Cập nhật địa chỉ cơ sở, thay đổi hotline, điều chỉnh trạng thái hoạt động...",
