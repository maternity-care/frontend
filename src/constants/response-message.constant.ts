export const RESPONSE_MESSAGES = {
    ...
    COMMON_DESCRIPTION: {
        ...
        ENTER_TITLE_SCHEDULE_EXAMPLE: "Ví dụ: Uống viên sắt, tái khám, đo huyết áp...",
    ...
    AUTH: {
        ...
        FORGOT_PASSWORD_DESCRIPTION: "Nhập email tài khoản để tạo link đặt lại mật khẩu.",
    ...
    SCHEDULE: {
        ...
        TITLE_DESCRIPTION: "Theo dõi lịch khám, siêu âm, xét nghiệm và tự tạo lịch nhắc trong quá trình mang thai.",
